<svelte:head><title>SvelteKit · Pxxl</title></svelte:head><main><span class="eyebrow">Pxxl boilerplate</span><h1>SvelteKit</h1><p>A server-rendered Svelte starter.</p><div class="status"><span class="dot"></span>Runtime ready</div></main><style>
